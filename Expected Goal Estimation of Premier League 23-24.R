# Introduction: This project analyzes the English Premier League (EPL) dataset for the 2023-24 season, focusing on predicting total goals scored in matches. The dataset includes various features such as Goals For (GF), Goals Against (GA), Expected Goals (xG), Shots (Sh), and other relevant statistics that can influence match outcomes.
