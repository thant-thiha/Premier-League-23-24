...
The goal of this project is to develop predictive models that can estimate the total goals scored in matches based on these features. Key steps include 
- data cleaning, 
- exploration, 
- modeling, and 
- evaluation.
